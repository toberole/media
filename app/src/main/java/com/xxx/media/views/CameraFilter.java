...
public class CameraFilter extends BaseImageFilter {
    ...
    public CameraFilter() {
        int mProgramHandle = GlUtil.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_OES);
    ...
    public void onInputSizeChanged(int mImageWidth, int mImageHeight) {

    }

    public void onDisplayChanged(int mViewWidth, int mViewHeight) {
